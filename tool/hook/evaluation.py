...
__all__ = ["EvalHook", "CustomDistEvalHook"]
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            dataloader, and return the test results. (default: ``None``)
    ...
    def __init__(
        ...
        **eval_kwargs,
        ...
        if test_fn is None:
            from tool.tester.utils import single_gpu_test
...
class DistEvalHook(EvalHook):
    ...
    def __init__(
        ...
        **eval_kwargs,
        ...
        if test_fn is None:
            from tool.tester.utils import multi_gpu_test
...
class CustomDistEvalHook(DistEvalHook):
    ...
    def _do_evaluate(self, runner):
        ...
        from tool.tester.test_sdk import custom_multi_gpu_test
