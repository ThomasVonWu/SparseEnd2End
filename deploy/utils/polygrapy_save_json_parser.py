...
# shell command: polygraphy run deploy/onnx/sparse4dbackbone.onnx --onnxrt --onnx-outputs mark all --save-results=onnx_out.json
subprocess.run(
    [
        "polygraphy",
        "run",
        ...
        "mark",
        "all",
        "--save-results=onnx_out.json",
    ],
    check=True,
)

# shell command: polygraphy run deploy/onnx/sparse4dbackbone.onnx --trt --trt-outputs mark all --save-results=trt_out.json
subprocess.run(
    [
        "polygraphy",
        "run",
