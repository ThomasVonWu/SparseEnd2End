...
${ENV_TensorRT_BIN}/trtexec --onnx=${ENV_BACKBONE_ONNX} \
                            ...
                            --dumpProfile \
                            --dumpLayerInfo \
                            --exportOutput=${ENVTRTLOGSDIR}/buildOutput_backbone.json\
                            --exportProfile=${ENVTRTLOGSDIR}/buildProfile_backbone.json \
                            --exportLayerInfo=${ENVTRTLOGSDIR}/buildLayerInfo_backbone.json \
                            --profilingVerbosity=detailed \
                            > ${ENVTRTLOGSDIR}/build_backbone.log 2>&1

echo "STEP2: build 1st frame sparse4dhead engine >>>>>>>>>>>>>>>>>>>>>>>>>>>"
sleep 2s
...
${ENV_TensorRT_BIN}/trtexec --onnx=${ENV_HEAD1_ONNX} \
                            ...
                            --dumpProfile \
                            --dumpLayerInfo \
                            --exportOutput=${ENVTRTLOGSDIR}/buildOutput_head1.json\
                            --exportProfile=${ENVTRTLOGSDIR}/buildProfile_head1.json \
                            --exportLayerInfo=${ENVTRTLOGSDIR}/buildLayerInfo_head1.json \
                            --profilingVerbosity=detailed \
                            > ${ENVTRTLOGSDIR}/build_head1.log 2>&1


echo "STEP3: build frame > 2 sparse4dhead engine >>>>>>>>>>>>>>>>>>>>>>>>>>>>"
sleep 2s
...
${ENV_TensorRT_BIN}/trtexec --onnx=${ENV_HEAD2_ONNX} \
                            ...
                            --dumpProfile \
                            --dumpLayerInfo \
                            --exportOutput=${ENVTRTLOGSDIR}/buildOutput_head2.json\
                            --exportProfile=${ENVTRTLOGSDIR}/buildProfile_head2.json \
